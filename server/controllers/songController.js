...
import { songRepository as repository } from '../repository/user.js';

export const userRouter = Router();

userRouter.put('/song/:id', async (req, res) => {
...
userRouter.get('/song/:id', async (req, res) => {
  // fetch the song and return it
  const song = await repository.fetch(req.params.id)
  res.send(song)
})

userRouter.delete('/song/:id', async (req, res) => {
...
userRouter.post('/songs', async (req, res) => {
...
userRouter.get('/songs/with-lyrics/:lyrics', async (req, res) => {
